  ...
  constructor() {
    ...
    recordButton.addEventListener('click', async () => {
      try {
        ...
        // Handle MIME types for browser compatibility
        let options = {};
    ...
    submitButton.addEventListener('click', async () => {
      try {
        ...
        if (uploadData.success) {
          ...
          const uploadResponse = await this.uploadToWixMediaManager(
...
customElements.define('audio-recorder14', AudioRecorder);
