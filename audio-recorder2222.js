  ...
  async submitRecording() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Dispatch the custom event to Wix page code, including the userName
        this.dispatchEvent(new CustomEvent('startLoadingEvent', {
          bubbles: true,
          composed: true,
          detail: { action: "addJob", userName: userName }
        }));
...
customElements.define('audio-recorder2222', AudioRecorder);
