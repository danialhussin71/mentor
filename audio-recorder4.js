class AudioRecorder extends HTMLElement {
    constructor() {
        ...
        submitButton.addEventListener('click', () => {
            ...
            // Correctly retrieving the blob from memory
            const blob = new Blob(chunks, { type: 'audio/mp3' });
            formData.append('file', blob, 'recording.mp3');  // Correctly appending the blob
...
customElements.define('audio-recorder4', AudioRecorder);
