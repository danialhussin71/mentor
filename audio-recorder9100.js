...
class AudioRecorder extends HTMLElement {
  ...
  initializeWaveSurfer() {
    ...
    // Optional: Handle waveform errors
    this.waveSurfer.on('error', (error) => {
      console.error('WaveSurfer error:', error);
      this.showMessage('Error loading waveform.', 'red');
    });
  }
  ...
  async submitRecording() {
    ...
    if (!userName) {
      this.showMessage('Please enter your mentor email.', 'red');
      return;
    }
...
customElements.define('audio-recorder9100', AudioRecorder);
