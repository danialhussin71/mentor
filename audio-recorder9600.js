  ...
  async startRecording() {
    try {
      ...
      this.mediaRecorder.onstop = async () => {
        ...
        this.blob = new Blob(this.chunks, { type: 'audio/webm' }); // Changed to 'audio/webm' or appropriate type
        this.chunks = [];
...
customElements.define('audio-recorder9600', AudioRecorder);
