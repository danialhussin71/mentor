    ...
    template.innerHTML = `
      <style>
        ...
        .left h2 {
          ...
          color: #ffeb3b; /* Highlighted color for headings */
        }
        ...
        .record-text {
          ...
          color: #4caf50; /* Green color indicating readiness */
        }
        ...
        #waveform {
          ...
          height: 80px;
          display: none;
          border-radius: 6px; /* Rounded edges for waveform */
          overflow: hidden;
    ...
    try {
      ...
      this.mediaRecorder.onstop = async () => {
        ...
        try {
          ...
          this.playButton.style.display = 'flex'; // Show play button
        } catch (error) {
...
customElements.define('audio-recorder9900', AudioRecorder);
